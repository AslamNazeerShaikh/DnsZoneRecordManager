...
{
    /// <summary>EF Core context for zones and records (In-Memory store, brief default).</summary>
    public class AppDbContext : DbContext
    {
        /// <summary>Creates a context with the given options.</summary>
        /// <param name="options">EF Core options (In-Memory database name comes from configuration).</param>
